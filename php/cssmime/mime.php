...
<head>
	...
	<link href="CSS/layout_mime.php" rel="stylesheet" type="text/css" />
...
<body>
	<div id="centre_content">
		<h2>Main content</h2>
		Go to the <a href="index.php">version with no explicit MIME-type declaration (doesn't render well in Firefox)</a>
